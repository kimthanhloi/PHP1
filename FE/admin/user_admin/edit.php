...
<?php 
    if(!empty($_GET['id'])){
        $userid = $_GET['id'] ; 
        $spl = "SELECT * FROM user_admin where id= '$userid' " ; 
...
<?php 
    if(isset($_POST['updateUser'])){
      ...
      $update_at = date('Y-m-d H:i:s');
        ...
        $spl = "UPDATE user_admin SET username = '$username',password= $password, email = '$userEmail',
         updated_at='$update_at'  where id = '$userid'" ; 
    ...
    <div class="main_login ">
        <form class="row g-3 was-validated" method="post">
            ...
            <div class="form-group">
                ...
                class="form-control" id="userEmail" placeholder="Enter password" name="userEmail"
                    required />
                <div class="valid-feedback">Hợp Lệ.</div>
                <div class="invalid-feedback">Vui Lòng Nhập.</div>
            </div>        
