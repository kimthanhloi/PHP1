...
<body>
    ...
    <div class="container main">
        ...
        <div class="login_admin">
            <a href="/index.php?pages=users&&action=add">
        ...
        <table class="table ">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="/index.php?pages=users&action=edit&id=<?php echo $data["id"]?>"
                            class="btn btn-dark" ><img
                                src='./admin/img/edit-1-svgrepo-com.svg'></a>
                        <a class="btn btn-danger"
                            href="/index.php?pages=users&action=delete&id=<?php echo $data["id"]?>"
