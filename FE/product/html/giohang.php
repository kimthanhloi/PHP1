...
<body>
    ...
    <div class="container">
                ...
                <form method="post">
                    <div class="cart__listbody">
                        <div class="cart__listbody-name">
                            ...
                            <div>Kiểu Dáng Thanh Lịch
                                Màu: den, Kích thước: 35</div>
                        </div>
                        <div class="cart__listbody-price">
                            <span> <?=      number_format($item['money'], 0, ",", ".") ?></span>đ
                        </div>
                        <div>
                            <!-- <button>-</button> -->
                            <div>
                                <input style="text-align: center;padding: 0px;width: 49px"
                                min="1"
                                 name="editqty" type="number" class="form-control text-center" 
                                 value="<?= $item['qty'] 
                        ...
                        <div class="cart__listbody-money">
                            <span> <?= number_format($total_product, 0, ",", ".") ?> </span>đ
            ...
            <div class="row">
                ...
                <div class="cart_totalmoney-item col l-6 m-12 c-12">
                    ...
                    <div class="cart_totalmoney-item--totalproduct">
                        <span>TỔNG</span>
                        <span> <?= isset($total_bill) ? (number_format($total_bill, 0, ",", ".")) : "" ?>
                            <span>đ</span></span>
                    </div>
        ...
        $_SESSION["dangky"]  ?? "" ;
        if($_SESSION["dangky"] ?? "" ){  ?>
        <form class="info_customer_buy" method="post" action="/index.php?pages=product_detail&action=buy">
            <div class="grid wide">
                <div class="row">
                    <input type="hidden" value="<?= $total_bill ?>" name="total_bill">
                    <div class="col  l-4 m-4 c-12 form_buy_info">
                        <input type="text"
                         name="username_info_customer_buy" placeholder="Họ Tên">
                    </div>
                    <div class="col  l-4 m-4 c-12 form_buy_info">
                    ...
                    <div class="col  l-4 m-4 c-12 form_buy_info">
                        <select class="form-select" id="ward" name="ward_info_customer_buy">
                    ...
                    <div class="col l-12 m-12 c-12 form_buy_info_submit">
        ...
        <?php  }else{
          echo  '
          <a href="/index.php?pages=product_detail&action=login">Vui lòng nhập Tài Khoản để xác nhận mua hàng</a>
          ' ;
        } ?>
        <section>
            <!-- paginnation -->
