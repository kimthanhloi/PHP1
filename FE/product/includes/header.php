...
<header id="header">
    <div class="grid wide header_in">
        ...
        <a href="/index.php?pages=product_detail&action=home" class="logo_header">
        ...
        <div class="header_login">
            ...
            <ul class="user_login">
                <li> <img  style="width: 40px; border-radius: 50%;"
                        ...
                        <li><a href="/index.php?pages=product_detail&action=logout">Đăng Xuất</a></li>
                    </ul>
                    </li>
                <li> <span style="margin-left: 10px;"><?php echo $_SESSION["dangky"]["name"]  ?></span></li>
            </ul>
            <?php }else{?>
            <a href="/index.php?pages=product_detail&action=login">
